    ...
    <nav class="bg-blue-600 text-white shadow">
        <div class="container mx-auto px-4 flex justify-between items-center py-4">
            ...
            <div class="space-x-4">
                ...
                <a href="{{ route('login') }}" class="hover:text-blue-300 font-semibold underline decoration-white decoration-2">Đăng nhập</a>
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
            ...
            <div class="text-center mt-4">
                <h6>Chưa có tài khoản? <a href="{{ url('/register') }}" class="text-blue-500 hover:underline text-sm">Đăng ký ngay</a></h6>
            </div>
        </div>
    </main>
